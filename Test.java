...
public class Test {
    ...
    public void testModificaCliente() {
        ...
        assertEquals("Jane", compagniaAerea.clienti.get("FL001").getNome());
    }
    ...
    public void testModificaVolo() {
        ...
        assertEquals("SFO", compagniaAerea.voli.get("FL001").getAeroportoArrivo());
    }

    @Test
    public void testRicercaCliente() {
        Cliente cliente = new Cliente("John", "Doe", "USA", "New York", "1990-01-15", "FL001");
        compagniaAerea.clienti.put(cliente.getCodiceCliente(), cliente);
    ...
    public void testRicercaClientePerNomeECognome() {
        ...
        compagniaAerea.clienti.put(cliente1.getCodiceCliente(), cliente1);
        compagniaAerea.clienti.put(cliente2.getCodiceCliente(), cliente2);
    ...
    public void testRicercaVolo() {
        ...
        compagniaAerea.voli.put(volo.getCodiceVolo(), volo);
